...
\n")
		...
		file = open(self.gngeorcPath,"w") #Opening (creating if doesn't exist).
		file.write(content[0]) #Writing.
		file.close() #And closing.

		file = open(self.xgngeoConfFile,"w") #Opening (creating if doesn't exist).
...
\n" % (mamename,version)
		...
		file = open(path,"w") #Open (creating if doesn't exist)
