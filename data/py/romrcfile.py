...
class Romrc:
	def parsing(self,romrc_path):
		"""Parse the `romrc' file to generate a Rom dictionary
		connecting the Rom MAME name to their full name and
		another dictionary with the inverse."""

		self.romFullToMame = {}
		self.romMameToFull = {}

		file = open(romrc_path,"r")
