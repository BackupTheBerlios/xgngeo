...
class Emulator:
    ...
    def getRomMameToFull(self):
        return self.romMameToFull

    def getRomFullToMame(self):
        return self.romFullToMame

    def getRomMameNames(self):
    ...
    def scanRomInDirectory(self, directory, filesel_dialog=False):
